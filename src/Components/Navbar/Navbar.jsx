    ...
    <div className='navbar'>
      ...
      <img src={menu_open} onClick={openMenu} alt="" className='nav-mob-open' />
       ...
       <img src={menu_close} onClick={closeMenu} alt="" className="nav-mob-close" />
        ...
        <li><AnchorLink className='anchorlink' offset={50} href='#skill'><p onClick={()=>setMenu("skill")}>Skills</p></AnchorLink>{menu==="skill"?<img src={underline} alt =''/>:<></>}</li>
        <li><AnchorLink className='anchorlink' offset={50} href='#work'><p onClick={()=>setMenu("work")}>Projects</p></AnchorLink>{menu==="work"?<img src={underline} alt =''/>:<></>}</li>
